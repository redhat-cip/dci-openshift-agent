...
install -p -D -m 644 templates/docker_distribution.yml.j2 %{buildroot}%{_datadir}/dci-openshift-agent/templates/docker_distribution.yml.j2
...
%{_datadir}/dci-openshift-agent/templates/docker_distribution.yml.j2
