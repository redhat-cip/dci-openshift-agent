...
find roles/opeator-sriov -type f -exec install -v -p -D -m 644 "{}" "%{buildroot}%{_datadir}/dci-openshift-agent/{}" \;
...
%changelog
* Sat Nov 24 2020 Thomas Vassilian <tvassili@redhat.com> - 0.1.1-2
