...
install -p -D -m 644 hooks/templates/install-openstack-config.j2 %{buildroot}%{_sysconfdir}/dci-openshift-agent/hooks/templates/install-openstack-config.j2
...
%config(noreplace) %{_sysconfdir}/dci-openshift-agent/hooks/templates/install-openstack-config.j2
