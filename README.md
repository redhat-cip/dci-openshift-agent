...
The `file_catalog` variable should be set to a valid tar file path generated using the oc mirror plugin to enable this feature. In the provided example, `file_catalog: /data/mirror_seq1_000000_414.tar` is used as the path to the images file.
