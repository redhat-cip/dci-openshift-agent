...
| performance_definition          | False    | String  |                                                                | Path of a Performance Profile YAML to apply during install (4.16 and above) or after the OCP install (4.15 and below). In order to allow a profile during installation the `customize_extramanifests_path` must be defined.
