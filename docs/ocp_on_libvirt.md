...
At this point, the `DCI Jumpbox` is installed with all above prerequisites ([learn how to install the DCI Jumpbox](https://github.com/redhat-cip/dci-openshift-agent#installation-of-dci-jumpbox)).
